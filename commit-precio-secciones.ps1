...
Write-Host "✅ Commit realizado con fecha: 2025-12-28T09:00:00" -ForegroundColor Green
Write-Host "📅 Para verificar la fecha: git log -1 --format='%ai %ci'" -ForegroundColor Cyan
